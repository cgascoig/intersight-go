...
// WithDollarApply adds the dollarApply to the get server profiles params
func (o *GetServerProfilesParams) WithDollarApply(dollarApply *string) *GetServerProfilesParams {
	o.SetDollarApply(dollarApply)
	return o
}

// SetDollarApply adds the dollarApply to the get server profiles params
func (o *GetServerProfilesParams) SetDollarApply(dollarApply *string) {
	o.DollarApply = dollarApply
}

// WithDollarCount adds the dollarCount to the get server profiles params
func (o *GetServerProfilesParams) WithDollarCount(dollarCount *bool) *GetServerProfilesParams {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the get server profiles params
func (o *GetServerProfilesParams) SetDollarCount(dollarCount *bool) {
	o.DollarCount = dollarCount
}

// WithDollarExpand adds the dollarExpand to the get server profiles params
func (o *GetServerProfilesParams) WithDollarExpand(dollarExpand *string) *GetServerProfilesParams {
	o.SetDollarExpand(dollarExpand)
	return o
}

// SetDollarExpand adds the dollarExpand to the get server profiles params
func (o *GetServerProfilesParams) SetDollarExpand(dollarExpand *string) {
	o.DollarExpand = dollarExpand
}

// WithDollarFilter adds the dollarFilter to the get server profiles params
func (o *GetServerProfilesParams) WithDollarFilter(dollarFilter *string) *GetServerProfilesParams {
	o.SetDollarFilter(dollarFilter)
	return o
}

// SetDollarFilter adds the dollarFilter to the get server profiles params
func (o *GetServerProfilesParams) SetDollarFilter(dollarFilter *string) {
	o.DollarFilter = dollarFilter
}

// WithDollarInlinecount adds the dollarInlinecount to the get server profiles params
func (o *GetServerProfilesParams) WithDollarInlinecount(dollarInlinecount *string) *GetServerProfilesParams {
	o.SetDollarInlinecount(dollarInlinecount)
	return o
}

// SetDollarInlinecount adds the dollarInlinecount to the get server profiles params
func (o *GetServerProfilesParams) SetDollarInlinecount(dollarInlinecount *string) {
	o.DollarInlinecount = dollarInlinecount
}

// WithDollarOrderby adds the dollarOrderby to the get server profiles params
func (o *GetServerProfilesParams) WithDollarOrderby(dollarOrderby *string) *GetServerProfilesParams {
	o.SetDollarOrderby(dollarOrderby)
	return o
}

// SetDollarOrderby adds the dollarOrderby to the get server profiles params
func (o *GetServerProfilesParams) SetDollarOrderby(dollarOrderby *string) {
	o.DollarOrderby = dollarOrderby
}

// WithDollarSelect adds the dollarSelect to the get server profiles params
func (o *GetServerProfilesParams) WithDollarSelect(dollarSelect *string) *GetServerProfilesParams {
	o.SetDollarSelect(dollarSelect)
	return o
}

// SetDollarSelect adds the dollarSelect to the get server profiles params
func (o *GetServerProfilesParams) SetDollarSelect(dollarSelect *string) {
	o.DollarSelect = dollarSelect
}

// WithDollarSkip adds the dollarSkip to the get server profiles params
func (o *GetServerProfilesParams) WithDollarSkip(dollarSkip *int32) *GetServerProfilesParams {
	o.SetDollarSkip(dollarSkip)
	return o
}

// SetDollarSkip adds the dollarSkip to the get server profiles params
func (o *GetServerProfilesParams) SetDollarSkip(dollarSkip *int32) {
	o.DollarSkip = dollarSkip
}

// WithDollarTop adds the dollarTop to the get server profiles params
func (o *GetServerProfilesParams) WithDollarTop(dollarTop *int32) *GetServerProfilesParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the get server profiles params
func (o *GetServerProfilesParams) SetDollarTop(dollarTop *int32) {
	o.DollarTop = dollarTop
}

// WithAt adds the at to the get server profiles params
func (o *GetServerProfilesParams) WithAt(at *string) *GetServerProfilesParams {
	o.SetAt(at)
	return o
}

// SetAt adds the at to the get server profiles params
func (o *GetServerProfilesParams) SetAt(at *string) {
	o.At = at
}
